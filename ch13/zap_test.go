...
func Example_zapJSON() {
	...
	// Output:
	// {"level":"debug","name":"example","caller":"ch13/zap_test.go:44","msg":"test debug message","version":"go1.24.1"}
	// {"level":"info","name":"example","caller":"ch13/zap_test.go:45","msg":"test info message","version":"go1.24.1"}
}
