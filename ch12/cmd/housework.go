...
import (
	...
	// storage "github.com/testaquatic/NetworkProgrammingWithGo/ch12/json"
	// storage "github.com/testaquatic/NetworkProgrammingWithGo/ch12/gob"
	"github.com/testaquatic/NetworkProgrammingWithGo/ch12/housework/v1"
	storage "github.com/testaquatic/NetworkProgrammingWithGo/ch12/protobuf"
)
...
func init() {
	...
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(),
			`Usage: %s [flags] [add chore, ...|complete #]", "housework"
